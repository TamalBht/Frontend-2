  ...
  const parallaxRef=useRef(null)
    ...
    <Section className="pt-[12rem] mt-[8.25rem] overflow-hidden " crosses crossesOffset="lg:translate-y-[5.25rem]" customPadding id="#hero">
        <div className='container relative overflow-hidden' ref={parallaxRef}>
            <div className='relative z-1 max-w-[32rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]'>
            ...
            <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
                ...
                <div className='absolute  -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[56%] md:w-[138%] lg:-top-[107%]' >
